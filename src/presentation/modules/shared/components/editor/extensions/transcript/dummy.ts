export const data = [
  {
    type: "paragraph",
    content: [
      { type: "text", marks: [{ type: "bold" }], text: "Naval: " },
      {
        type: "text",
      ...
      { type: "text", marks: [{ type: "italic" }], text: "Genome" },
      {
        type: "text",
        text: " . I must have six or ☇ seven dog-eared copies of it lying around in various boxes. It helped me define what life is, how it works, why it’s important, and placed evolution as a binding principle in the center of my worldview. That’s a common theme that runs across Matt’s books. ",
      },
    ],
  },
  {
    type: "paragraph",
    content: [
      { type: "text", text: 'After that, I read his book{" "} ' },
      {
        type: "text",
        marks: [{ type: "italic" }],
        text: "The Red Queen",
      ...
      {
        type: "text",
        text: ' , which laid out the age-old competition between bacteria, viruses and humans—a topic that’s extremely relevant today. I also read his book{" "} ',
      },
      {
        type: "text",
        marks: [{ type: "italic" }],
        text: "The Rational Optimist",
      },
      {
        type: "text",
        text: " , which helped me realize that it was rational to be optimistic, because of the technological and scientific advancement that we’ve had as human species since we first came across the stone ax and basic tools.",
      },
    ],
  },
  {
    type: "paragraph",
    content: [
      { type: "text", text: 'His book{" "} ' },
      {
        type: "text",
        marks: [{ type: "italic" }],
        text: "The Origins of Virtue",
      },
      {
        type: "text",
        text: ' {" "} helped me take a game-theoretical framework towards virtues and ethics. His book{" "} ',
      },
      {
        type: "text",
        marks: [{ type: "italic" }],
        text: "The Evolution of Everything",
      },
      {
        type: "text",
        text: ' {" "} continued that theme towards everything evolving. I’m sad to say I’ve missed one or two of your books in there, Matt.{" "} ',
      },
      {
        type: "text",
        marks: [{ type: "italic" }],
      ...
      {
        type: "text",
        text: " , I have to go back and read that one. And most recently, ",
      },
    ],
  },
  {
    type: "paragraph",
    content: [
      { type: "text", text: 'Matt wrote a great book called{" "} ' },
      {
        type: "text",
        marks: [{ type: "italic" }],
      ...
      {
        type: "text",
        text: " , which will be out by the time this podcast is out there. I had the pleasure of reading an advance copy over the last week.",
      },
    ],
  },
  {
    ...
    content: [
      {
        type: "text",
        text: "Welcome, Matt. I’m honored to have you here. Do you want to give us a little bit of your background and how you got into writing about science?",
      },
    ],
  },
  {
    type: "paragraph",
    content: [
      { type: "text", marks: [{ type: "bold" }], text: "Matt:" },
      {
        type: "text",
        text: ' Naval, it’s great to meet you and interesting to hear that story of how you’ve read so many of my books and got the point of them. It’s wonderful. I’m someone who’s enjoyed writing all my life. I became a professional journalist after a brief career as a scientist. I only got as far as doing a PhD in biology and then decided that I wanted to be a writer instead. So I became a journalist. I was a science editor at{" "} ',
      },
      {
        type: "text",
        marks: [{ type: "italic" }],
      ...
      {
        type: "text",
        text: "for a number of years and also served as a political reporter and correspondent there as well.",
      },
    ],
  },
  {
    ...
    content: [
      {
        type: "text",
        text: 'I then became a freelance writer. That was when I wrote{" "} ',
      },
      {
        type: "text",
        marks: [{ type: "italic" }],
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "text",
        text: "I read this book in preparation for this conversation, so it’s suffered from becoming a chore. Because normally one reads purely for enjoyment at their leisure and this time it became more about hitting a deadline. That said, this has been your most impactful book for me since ",
      },
      { type: "text", marks: [{ type: "italic" }], text: "Genome" },
      {
        type: "text",
        text: ". It was very revealing. There are two things about this book that put it in a different class than your previous books, for me.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        text: "He came back and he said, “Well, the basic theme is freedom. Have you realized that?” And I said, “I don’t think I have realized that, no.” I then rewrote some sections, and that’s probably where that soundbite came from. It was one of the last rewrites.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "text",
        text: "This is something that you learn in Silicon Valley very early on, that ideas are a dime a dozen. Every idea has been floating around. Even a lot of the old ideas that failed weren’t necessarily bad ideas; they were just the wrong time.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "text",
        text: "One of the things I’m doing in this book is slightly downplaying the importance of disruption. Most of the time innovation is an incremental process. It looks disruptive when you’re looking backwards. but at the time it’s surprisingly gradual. The first version of a new technology looks surprisingly like the last version of an old technology.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        text: "Oliver and Wilbur Wright created the airplane; Samuel Morse created the telegraph; Alexander Graham Bell created the telephone; Newton and Leibniz discovered calculus—without them we would have been stuck in the Dark Ages for god knows how long. That was my view of how the world worked.",
      },
    ],
  },
  {
    ...
    content: [
      {
        type: "text",
        text: "“There’s an old quip in Silicon Valley that the reason we do well is because we operate in the last unregulated domain.”",
      },
    ],
  },
  {
    ...
    content: [
      {
        type: "text",
        text: "When I came to Silicon Valley, I looked around and I didn’t see that happening. I didn’t see a single genius inventor creating a single thing that suddenly changed the world. I saw, instead, lots of people doing lots of tinkering.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        text: "Orville Vogel had gotten these varieties from Cecil Salmon, who’d been on Douglas MacArthur’s staff in Tokyo at the end of the war and had visited agricultural stations in Japan and found these dwarf varieties growing. And they had been developed, crossed, hybridized and bred by Gonjiro Inazuka, and he had got them from somewhere in the Korean Peninsula. And at this point the trail goes cold.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        text: "America is the exception that seems to prove this rule. Although it looks like an empire from the outside—a great, big unified country—once you get inside it you find that California has a quite different regime from other parts. Even this week, Elon Musk was talking about leaving California and moving to Texas because he’s so upset with the way they’re treating the end of lockdown. It’s like a 15th Century European innovator threatening to leave one part of Germany for another part of Germany.",
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        type: "text",
        text: "For a long time I had thought, despite the poor political governance, California was impregnable. It had too much of a network effect; the lock was too strong. But now I can see the cracks.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        text: "“I wouldn’t be surprised if the next Silicon Valley moves to the cloud.”",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "text",
        text: " Thank you very much for that, because that has filled in a gap in my understanding in one go. I’ve always been interested in the fact that these innovation bush fires eventually are extinguished by some combination of chiefs, priests and thieves, if you like. ",
      },
    ],
  },
  {
    ...
    content: [
      ...
      {
        type: "text",
        text: " I like that: chiefs, priests and thieves. Or, as a wag might say, “Chiefs, priests and thieves—what’s the difference?”",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        text: "“What if America does lose its mojo and we have to rely on China for the world’s innovation engine?”",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        text: "But India has done this before. It was probably the first place to start all this going. A place of free thought and a lot of spontaneous order— a lot of spontaneous disorder, too. Maybe that’s the place. But you’ve given me another prospect, which is this escape from the chiefs, priests and thieves into the cloud where it can be out of their reach for at least long enough until they work out how to reach it.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        text: "“California doesn’t create entrepreneurs. California attracts entrepreneurs.”",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        text: "California doesn’t create entrepreneurs. California attracts entrepreneurs. China is not going to be an attractor, and it will always be limited because of that. Even though India has a lot of the other elements, it doesn’t have the basic infrastructure to make it an attractive place to go. Because of its poverty level, India also has a very anti-innovation culture. Innovators in India often survive by keeping their heads down. You can see this in how India banned crypto. Hopefully that’ll get overturned, but they can do things like that. Early on something got listed on eBay India that wasn’t supposed to be listed, so they just rounded up the local eBay managers and threw them in jail.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      {
        type: "text",
        text: 'We’re not going to be able to stop India and China from growing. We’re not going to be able to stop them from innovating. We’re not going to be able to stop them from modernizing. We can do what Elon Musk does: He says let me give them solar-powered electric cars and rockets as quickly as possible so they can jump through the wasteful phase of innovation, where there’s a lot of environmental destruction, and get to the part where we can all afford clean rivers beautiful forests, nice parks and other species in our environment. By the way, I credit this to{" "} ',
      },
      { type: "text", marks: [{ type: "italic" }], text: "Genome" },
      { type: "text", text: " . The book paints a picture of utopia." },
    ],
  },
  {
    type: "paragraph",
    content: [
      {
        type: "text",
        text: "Not in the sense of a top-down, human-enforced, platonic sense of this is how the world should be run, but in how the natural world is designed and operates, and our role in it. ",
      },
      { type: "text", marks: [{ type: "italic" }], text: "Genome " },
      {
        type: "text",
        text: "paints a picture of paradise being a garden. This is in our deeply embedded myths: The paradise that Adam and Eve live in is a garden. They fall from grace, and they fall out of the garden. ",
      },
    ],
  },
  {
